...
/**
 * A placeholder type specifier which accepts only @c NSString or @c NSNull for @c InsightsUserDetails default properties.
 */
@protocol InsightsUserDetailsNullableString <NSObject>
@end
@interface NSString (NSStringWithInsightsUserDetailsNullableString) <InsightsUserDetailsNullableString>
@end
@interface NSNull (NSNullWithInsightsUserDetailsNullableString) <InsightsUserDetailsNullableString>
@end


/**
 * A placeholder type specifier which accepts only @c NSDictionary or @c NSNull for @c InsightsUserDetails default properties.
 */
@protocol InsightsUserDetailsNullableDictionary <NSObject>
@end
@interface NSDictionary (NSDictionaryWithInsightsUserDetailsNullableDictionary) <InsightsUserDetailsNullableDictionary>
@end
@interface NSNull (NSNullWithInsightsUserDetailsNullableDictionary) <InsightsUserDetailsNullableDictionary>
@end


/**
 * A placeholder type specifier which accepts only @c NSNumber or @c NSNull for @c InsightsUserDetails default properties.
 */
@protocol InsightsUserDetailsNullableNumber <NSObject>
@end
@interface NSNumber (NSNumberWithInsightsUserDetailsNullableNumber) <InsightsUserDetailsNullableNumber>
@end
@interface NSNull (NSNullWithInsightsUserDetailsNullableNumber) <InsightsUserDetailsNullableNumber>
@end

extern NSString* const kInsightsLocalPicturePath;

@interface InsightsUserDetails : NSObject
 ...
 */
@property (nonatomic, copy) id<InsightsUserDetailsNullableString> _Nullable name;
 ...
 * It will be sent to server when @c recordUserDetails method is called.
 */
@property (nonatomic, copy) id<InsightsUserDetailsNullableString> _Nullable username;
 ...
 * It will be sent to server when @c recordUserDetails method is called.
 */
@property (nonatomic, copy) id<InsightsUserDetailsNullableString> _Nullable email;
 ...
 * It will be sent to server when @c recordUserDetails method is called.
 */
@property (nonatomic, copy) id<InsightsUserDetailsNullableString> _Nullable organization;
 ...
 * It will be sent to server when @c recordUserDetails method is called.
 */
@property (nonatomic, copy) id<InsightsUserDetailsNullableString> _Nullable phone;
 ...
 */
@property (nonatomic, copy) id<InsightsUserDetailsNullableString> _Nullable gender;

/**
 * Default @c pictureURL property for user's profile photo in User Profiles.
 * @discussion It can be set to an @c NSString, or @c NSNull for clearing it on server.
 * It will be sent to server when @c recordUserDetails method is called.
 * @discussion It should be a publiINS accessible URL string to user's profile photo, so server can download it.
 */
@property (nonatomic, copy) id<InsightsUserDetailsNullableString> _Nullable pictureURL;
 ...
 */
@property (nonatomic, copy) id<InsightsUserDetailsNullableString> _Nullable pictureLocalPath;
 ...
 * It will be sent to server when @c recordUserDetails method is called.
 */
@property (nonatomic, copy) id<InsightsUserDetailsNullableNumber> _Nullable birthYear;
 ...
 */
@property (nonatomic, copy) id<InsightsUserDetailsNullableDictionary> _Nullable custom;

/**
 * Returns @c InsightsUserDetails singleton to be used throughout the app.
 * @return The shared @c InsightsUserDetails object
 * @discussion @c Insights.user convenience accessor can also be used.
 */

...
extern NSString* const kInsightsReservedEventSurvey;
extern NSString* const kInsightsReservedEventNPS;
 ...
 * @discussion Calls to this method will be ignored if consent for @c INSConsentFeedback is not given
 ...
 * @discussion Calls to this method will be ignored if consent for @c INSConsentFeedback is not given while @c requiresConsent flag is set on initial configuration.

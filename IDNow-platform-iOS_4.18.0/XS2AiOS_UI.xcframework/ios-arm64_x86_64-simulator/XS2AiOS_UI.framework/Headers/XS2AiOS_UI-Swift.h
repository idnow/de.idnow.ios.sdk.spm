...
#ifndef XS2AIOS_UI_SWIFT_H
#define XS2AIOS_UI_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="XS2AiOS_UI",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10XS2AiOS_UI18XS2AViewController")
@interface XS2AViewController : UIViewController <UIAdaptivePresentationControllerDelegate>
